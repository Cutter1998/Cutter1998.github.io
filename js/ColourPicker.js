document.addEventListener("DOMContentLoaded", function(){
	if(localStorage.getItem("bannerColour") === null){
		...
		document.getElementById('contactMeContainer').style.backgroundColor = "#60bdb1";
	}
	else{
		...
		document.getElementById('contactMeContainer').style.backgroundColor = localStorage.getItem("bannerColour");
	}
})
...
function changeBannerColour(){
	...
	document.getElementById('contactMeContainer').style.backgroundColor = document.getElementById('colourPicker').value;
